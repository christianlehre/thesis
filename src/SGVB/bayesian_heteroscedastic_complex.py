...
class BayesianRegressor(nn.Module):
    def __init__(self, layers, n_batches, dropout_rate):
        ...
        self.bfc_logvar = BayesianLinear(n_in, n_out, self.kl_loss, n_batches, prior_mu=0, prior_sigma=1)
...
if __name__ == "__main__":
    ...
    model = BayesianRegressor(layers=layers, n_batches=M, dropout_rate=dropout_rate)

    training_conf = "sgvb_heteroscedastic_complex"
    ...
    plt.title("Loss curves - complex Heteroscedastic SGVB", fontsize=18)
